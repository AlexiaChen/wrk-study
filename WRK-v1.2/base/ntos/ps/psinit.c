...

{
	...
	/*
		系统初始化时，线程对象和进程对象的创建。一个很好的ObCreateObjectType
		函数使用例子，请参考对象管理器的Ob.h文件.
		*/
   ...
   */
    ...
    ObjectTypeInitializer.DeleteProcedure = PspProcessDelete;   //指定了进程对象的删除例程
    ...
    ObjectTypeInitializer.DeleteProcedure = PspThreadDelete;////指定了线程对象的删除例程
